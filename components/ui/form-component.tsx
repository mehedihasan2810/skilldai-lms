...
const models = [
  {
    ...
    label: "GPT-4o Mini",
    icon: Zap,
    description: "God speed, good quality",
    color: "emerald",
    vision: true,
  },
  {
    ...
    icon: Sparkles,
    description: "Good quality, high speed",
    color: "orange",
    vision: false,
  },
  {
    ...
    icon: ArrowLeft,
    description: "Good quality, normal speed",
    color: "glossyblack",
    vision: true,
  },
  {
    ...
    icon: Sparkles,
    description: "High quality, good speed",
    color: "indigo",
    vision: true,
  },
  {
    ...
    label: "GPT-4o",
    icon: Cpu,
    description: "Higher quality, normal speed",
    color: "blue",
    vision: true,
  },
];
            ...
            <model.icon
              className={cn(
                ...
                selectedModel === model.value
                  ? "text-white"
                  : `text-${model.color}-500 dark:text-${model.color}-400`
              )}
            />
            <div>
...
> = {
  web: {
    ...
    bgSelected:
      "!bg-cyan-50 dark:!bg-cyan-950/40 !border-cyan-500 dark:!border-cyan-400",
  ...
  academic: {
    ...
    bgSelected:
      "!bg-violet-50 dark:!bg-violet-950/40 !border-violet-500 dark:!border-violet-400",
  ...
  youtube: {
    ...
    bgSelected:
      "!bg-red-50 dark:!bg-red-950/40 !border-red-500 dark:!border-red-400",
  ...
  x: {
    ...
    bgSelected:
      "!bg-neutral-50 dark:!bg-neutral-800/40 !border-neutral-500 dark:!border-neutral-400",
...
const FormComponent: React.FC<FormComponentProps> = ({
  ...
  return (
    <div
      className={cn(
        "relative w-full flex flex-col gap-2 rounded-lg transition-all duration-300 z-[51] bg-secondary",
        attachments.length > 0 || uploadQueue.length > 0 ? "bg-secondary" : ""
      )}
    >
      <input
        type="file"
      ...
      <div className="relative">
        ...
        <div
          className={cn(
            "absolute bottom-0 inset-x-0 flex justify-between items-center rounded-b-lg p-2 bg-secondary",
            "!border !border-t-0 ",
